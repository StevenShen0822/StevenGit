...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <fieldUpdates>
        ...
        <field>Name</field>
        <formula>IF(NOT(ISBLANK(Zip_Code__c)), Zip_Code__r.ZipCode__c + &apos; - &apos;, &apos;&apos;) + 
IF(NOT(ISBLANK(Market__c)), Market__r.Name + &apos; - &apos;, &apos;&apos;) + IF(NOT(ISBLANK(Category__c)), Category__r.Name + &apos; - &apos;, &apos;&apos;) + 
Sales_Rep__r.FirstName + &apos; &apos; + Sales_Rep__r.LastName</formula>
