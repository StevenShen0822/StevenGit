...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        ...
        <active>true</active>
        <formula>OR(    if(       Past_Due_Invoice__c, True, if(  Charge_Back_Balance__c  &lt;&gt; 0, True, False)    ), if(      OR(TEXT(Customer_Type__c) == &apos;AMS&apos;, TEXT(Customer_Type__c) == &apos;BANKRUPTCY&apos;, TEXT(Customer_Type__c) == &apos;CC CHARGEBACK&apos;, TEXT(Customer_Type__c) == &apos;CNCXLD BAD PAY&apos;, TEXT(Customer_Type__c) == &apos;CREDIT HOLD&apos;, TEXT(Customer_Type__c) == &apos;OUT OF BUSINESS&apos;, TEXT(Customer_Type__c) == &apos;MB&amp;W&apos;,
TEXT(Customer_Type__c) == &apos;CBP-In House&apos;,TEXT(Customer_Type__c) == &apos;ACH RETURN&apos; ) 
, True, False    ) )</formula>
    ...
    <rules>
        ...
        <active>true</active>
        <formula>NOT( OR(    if(       Past_Due_Invoice__c, True, if(  Charge_Back_Balance__c  &lt;&gt; 0, True, False)    ), if(      OR(TEXT(Customer_Type__c) == &apos;AMS&apos;, TEXT(Customer_Type__c) == &apos;BANKRUPTCY&apos;, TEXT(Customer_Type__c) == &apos;CC CHARGEBACK&apos;, TEXT(Customer_Type__c) == &apos;CNCXLD BAD PAY&apos;, TEXT(Customer_Type__c) == &apos;CREDIT HOLD&apos;,  TEXT(Customer_Type__c) == &apos;OUT OF BUSINESS&apos;, TEXT(Customer_Type__c) == &apos;MB&amp;W&apos;,
TEXT(Customer_Type__c) == &apos;CBP-In House&apos;,TEXT(Customer_Type__c) == &apos;ACH RETURN&apos; ) , True, False    ) ) )</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
