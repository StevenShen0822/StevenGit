...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <alerts>
        <fullName>Open_Cancelled_Case_Email_Alert_for_Case_Team</fullName>
        <ccEmails>escalations@theknot.com</ccEmails>
        <description>Open Cancelled Case Email Alert for Case Team</description>
        <protected>false</protected>
        <recipients>
            <type>accountOwner</type>
        </recipients>
    ...
    <alerts>
        <fullName>Send_Email_For_Inbound_Sales_VM_Case</fullName>
        <description>Send Email For Inbound Sales VM Case</description>
        <protected>false</protected>
        <recipients>
            <type>owner</type>
        </recipients>
...
Subject &amp; &quot; [ ref:_&quot; &amp; LEFT($Organization.Id,5) &amp; SUBSTITUTE(RIGHT($Organization.Id,10), &quot;0&quot;, &quot;&quot; )&amp; &quot;._&quot; &amp; LEFT(Id,5) &amp; SUBSTITUTE(Left(RIGHT(Id,10), 5), &quot;0&quot;, &quot;&quot;) &amp; RIGHT(Id,5) &amp; &quot;:ref ]&quot;
    ...
    <rules>
        ...
        <formula>AND(  RecordType.Name=&quot;1 - Cancels&quot;,    NOT(ISBLANK(ContactId)),     OR(          ISNEW(),          ISCHANGED(ContactId)           )   )</formula>
...
Update by CSP-2484</description>
        <formula>AND(   RecordType.Name=&quot;1 - Cancels&quot;,   NOT(ISBLANK(AccountId)),   OR(     ISNEW(),     ISCHANGED(AccountId),     AND(       ISPICKVAL(PRIORVALUE( Status ),&apos;CLOSED&apos;) ,        NOT(ISPICKVAL( Status ,&apos;CLOSED&apos;))      )   ),   Account.VIP_Program__c )</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        ...
        <formula>AND(RecordType.Name=&quot;1 - Cancels&quot;,    NOT(ISBLANK(AccountId)),    CreatedById &lt;&gt; Account.OwnerId,    OR(        ISNEW(),    ISCHANGED(AccountId),             AND(          ISPICKVAL(PRIORVALUE(Status),&apos;CLOSED&apos;) ,           NOT(ISPICKVAL(Status ,&apos;CLOSED&apos;)))      ),   NOT(Account.VIP_Program__c)    )</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
...
NOT(ISBLANK(SubscriptionProductCharge__c )) 
  ...
  Or(
    ...
    <rules>
        ...
        <active>true</active>
        <description>This will take the amount in Account Past Due Balance, and set this field so we have a stamped, static value that reflects what it was when the case was created.(SS-5733)</description>
        <formula>AND(
NOT(ISBLANK(AccountId)) ,
...
OR(ISNEW(),ISCHANGED(AccountId))
    ...
    <rules>
        <fullName>TEST ES-11612</fullName>
        <actions>
            <name>Send_Email_For_Inbound_Sales_VM_Case</name>
            <type>Alert</type>
        </actions>
        <active>false</active>
        <formula>AND(
ISCHANGED(OwnerId),
PRIORVALUE(OwnerId) = &apos;00Gf1000002nipP&apos;,
RecordType.Name = &apos;Voicemail&apos;,
ISPICKVAL(Voicemail_Type__c,&apos;Inbound Sales&apos;))</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
