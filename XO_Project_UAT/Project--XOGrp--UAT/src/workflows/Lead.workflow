...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        ...
        <formula>AND(     Record_Type_Name__c = &apos;Local&apos;,    ISPICKVAL(LeadSource , &apos;Self Prospecting&apos;),    CONTAINS(CreatedBy.UserRole.Name, &apos;Sales Representative&apos;),      !CONTAINS(CreatedBy.UserRole.Name, &apos;BDR&apos;),      !ISBLANK(Category_Group__c ),    Category_Group__c  = &apos;Secondary&apos;,    !ISPICKVAL(Lead_Creator_Type__c, &apos;Skip Assignment Rule&apos;),    ISPICKVAL(Status, &apos;Valid&apos;) )</formula>
    ...
    <rules>
        ...
        <active>true</active>
        <description>CSP-2791</description>
        <formula>             AND(                 ISPICKVAL(LeadSource , &quot;Website&quot;),                 BEGINS(OwnerId, &quot;005&quot;),                  TODAY() = DATEVALUE(CreatedDate),                 OwnerId != &quot;005j000000DU2D8&quot;,                 OR(                     ISCHANGED(LeadSource),                     ISCHANGED(OwnerId),                     ISNEW()                     )                    )</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        ...
        <active>false</active>
        <description>CSP-2791</description>
        <formula>AND(     RecordType.Name = &apos;Local&apos;,     ISPICKVAL(Status, &apos;Valid&apos;),      Portfolio__c = &apos;Senior Sales Executive&apos;,      !ISPICKVAL(LeadSource , &apos;Paid Media&apos;),     !ISPICKVAL(Lead_Creator_Type__c, &apos;Skip Assignment Rule&apos;),     OR(         AND(             !CONTAINS(CreatedBy.UserRole.Name, &apos;BDR&apos;),             !CONTAINS(CreatedBy.UserRole.Name, &apos;Senior Sales Executive&apos;),             !CONTAINS(CreatedBy.UserRole.Name, &apos;Inbound Sales Executive&apos;),             !CONTAINS(CreatedBy.UserRole.Name, &apos;Sales Representative&apos;)         ),         !ISPICKVAL(LeadSource , &apos;Self Prospecting&apos;),         ISNULL(Primary_Category__c),         AND(             !ISBLANK(Category_Group__c),             !(Category_Group__c  = &apos;Primary&apos;),             !(Category_Group__c  = &apos;Secondary&apos;)         )     ) )</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        ...
        <active>false</active>
        <description>CSP-2791</description>
        <formula>AND(              RecordType.Name = &apos;Local&apos;,               ISPICKVAL(LeadSource , &apos;Self Prospecting&apos;),              CONTAINS(CreatedBy.UserRole.Name, &apos;Senior Sales Executive&apos;),              !ISBLANK(Category_Group__c ),              Category_Group__c  = &apos;Secondary&apos;,              !ISPICKVAL(Lead_Creator_Type__c, &apos;Skip Assignment Rule&apos;),              ISPICKVAL(Status, &apos;Valid&apos;)            )</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        ...
        <active>true</active>
        <description>Phase 1 National - populate EmailAccount__c with Email</description>
        <formula>OR(
        ISNEW(),
        ISCHANGED(Email),
