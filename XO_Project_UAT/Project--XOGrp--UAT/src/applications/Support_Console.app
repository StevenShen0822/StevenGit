...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    <consoleConfig>
        <componentList>
            ...
            <components>Distribution_Engine</components>
        </componentList>
    ...
    <description>This app is for our Local Core Strategy Specialists and Local Core Finance ARR teams so that they can use it for New Voice Media</description>
    ...
    <tabs>Waitlist</tabs>
    <tabs>Callback_Queue</tabs>
    <tabs>My_Tasks</tabs>
    <tabs>Approval_Item</tabs>
    <tabs>RenewalDashboard</tabs>
    <tabs>Compensation_Role__c</tabs>
    <workspaceConfig>
        <mappings>
            <tab>Approval_Item</tab>
        </mappings>
        <mappings>
            <tab>Callback_Queue</tab>
        </mappings>
        <mappings>
            <tab>Compensation_Role__c</tab>
        </mappings>
        <mappings>
            <tab>My_Tasks</tab>
        </mappings>
        <mappings>
            <tab>RenewalDashboard</tab>
        </mappings>
        <mappings>
            <tab>Waitlist</tab>
        </mappings>
