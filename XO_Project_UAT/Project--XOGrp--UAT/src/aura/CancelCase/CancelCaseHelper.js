({
  ...
  SAVED_BY_VALUES: [
    '',
    'change of market/category',
    'dashboard / stats walkthrough',
    'downsell/remove upgrades',
    'offering non-renewal',
    'rate freeze',
    'reset expectations',
    'storefront redesign',
    'upsell',
    ...
    return new Promise(function(resolve, reject) {
      ...
      action.setCallback(this, function(response){
        ...
        if (state === 'SUCCESS') {
          ...
          console.log('originOptions',allOptions.originOptions);
   ...
   */
  saveCase: function(component, goNext, insertOpp, isAssignOwner, isSaveLater) {
    console.log('isSaveLater',isSaveLater);
    ...
    return uploadFilePromise
      .then($A.getCallback(function() {
        return new Promise(function(resolve, reject) {
          ...
          action.setParams({
            caseValuesStr: JSON.stringify(currentCase),
        ...
        var returnValue = response.getReturnValue();
                console.log('save returnValue', returnValue);
                component.set('v.oppId', returnValue.OpportunityId);
                resolve();
            } else {
      ...
      .then($A.getCallback(function() {
        ...
        if(goNext && currentPage !== 3) {
          self.next(component);
        } else if(currentPage === 3 && oppId !== '') {
